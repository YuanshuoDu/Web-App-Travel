    ...
    return (
      <Container>
        ...
        <Paper className={classes.paper} elevation={4}>
          ...
          >
            <Typography className={classes.createStory} variant="h6">
              {"Creating new Story"}
            </Typography>
            <TextField
              name="title"
            ...
            >
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    setStoryData({ ...storyData, country: e.target.value })
                  }
                />
              </Grid>
              <Grid item xs={6}>
                <TextField
                  ...
                  label="City"
                  fullWidth
                  value={storyData.city}
                  onChange={(e) =>
                    setStoryData({ ...storyData, city: e.target.value })
                  }
                />
              </Grid>
            </Grid>
            ...
            <div className={classes.fileInput}>
              <FileBase
                ...
                multiple={false}
                onDone={({ base64 }) =>
                  setStoryData({ ...storyData, selectedPicture: base64 })
                }
              />
            </div>
            <Button
